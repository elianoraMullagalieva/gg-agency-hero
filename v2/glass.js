...
(function () {
  ...
  // Три вложенные оболочки вместо одной: материал полупрозрачный,
  // и одиночная стенка просвечивала насквозь. Слои копят плотность,
  // а разная скорость вращения даёт живое нутро.
  var SPEC = [
    { p: [0, 0, 0], s: 1.00, cfg: RED, spin: -0.16 },
    { p: [0, 0, 0], s: 0.93, cfg: RED, spin:  0.11 },
    { p: [0, 0, 0], s: 0.84, cfg: RED, spin: -0.07 }
  ];
